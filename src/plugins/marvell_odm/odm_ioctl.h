...
/* ODM transfer direction (device -> host/GPU or host/GPU -> device). */
#define ODM_DIR_TO_GPU 0 /* device -> host DRAM or GPU VRAM (READ / READ_FD) */
#define ODM_DIR_FROM_GPU 1 /* host DRAM or GPU VRAM -> device (WRITE / WRITE_FD) */
